...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  "use strict";_gsScope._gsDefine("easing.CustomEase", ["easing.Ease"], function (a) {
    var b = /(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
      ...
      var b,
        ...
        var b = +a;return 1e-4 > b && b > -1e-4 ? 0 : b;
          ...
          s = 0,
          t = p.length,
          u = 2;for (b = 0; t > b; b++) if ((m = h, isNaN(p[b]) ? (h = p[b].toUpperCase(), i = h !== p[b]) : b--, e = +p[b + 1], g = +p[b + 2], i && (e += r, g += s), b || (k = e, l = g), "M" === h)) j && j.length < 8 && (q.length -= 1, u = 0), r = k = e, s = l = g, j = [e, g], u = 2, q.push(j), b += 2, h = "L";else if ("C" === h) j || (j = [0, 0]), j[u++] = e, j[u++] = g, i || (r = s = 0), j[u++] = r + 1 * p[b + 3], j[u++] = s + 1 * p[b + 4], j[u++] = r += 1 * p[b + 5], j[u++] = s += 1 * p[b + 6], b += 6;else if ("S" === h) "C" === m || "S" === m ? (n = r - j[u - 4], o = s - j[u - 3], j[u++] = r + n, j[u++] = s + o) : (j[u++] = r, j[u++] = s), j[u++] = e, j[u++] = g, i || (r = s = 0), j[u++] = r += 1 * p[b + 3], j[u++] = s += 1 * p[b + 4], b += 4;else {
      ...
      a = a || "0,0,1,1";var d,
          ...
          s = a.match(b),
          t = 1,
          u = [];if ((c = c || {}, r = c.precision || 1, this.data = a, this.lookup = [], this.points = u, this.fast = 1 >= r, (e.test(a) || -1 !== a.indexOf("M") && -1 === a.indexOf("C")) && (s = h(a)), d = s.length, 4 === d)) s.unshift(0, 0), s.push(1, 1), d = 8;else if ((d - 2) % 6) throw f;for ((0 !== +s[0] || 1 !== +s[d - 2]) && j(s, c.height, c.originY), this.rawBezier = s, l = 2; d > l; l += 6) i = { x: +s[l - 2], y: +s[l - 1] }, k = { x: +s[l + 4], y: +s[l + 5] }, u.push(i, k), g(i.x, i.y, +s[l], +s[l + 1], +s[l + 2], +s[l + 3], k.x, k.y, 1 / (2e5 * r), u, u.length - 1);for (d = u.length, l = 0; d > l; l++) o = u[l], p = u[l - 1] || o, o.x > p.x || p.y !== o.y && p.x === o.x || o === p ? (p.cx = o.x - p.x, p.cy = o.y - p.y, p.n = o, p.nx = o.x, this.fast && l > 1 && Math.abs(p.cy / p.cx - u[l - 2].cy / u[l - 2].cx) > 2 && (this.fast = !1), p.cx < t && (p.cx ? t = p.cx : (p.cx = .001, l === d - 1 && (p.x -= .001, t = Math.min(t, .001), this.fast = !1)))) : (u.splice(l--, 1), d--);if ((d = 1 / t + 1 | 0, this.l = d, m = 1 / d, n = 0, o = u[0], this.fast)) {
        for (l = 0; d > l; l++) q = l * m, o.nx < q && (o = u[++n]), i = o.y + (q - o.x) / o.cx * o.cy, this.lookup[l] = { x: q, cx: m, y: i, cy: 0, nx: 9 }, l && (this.lookup[l - 1].cy = i - this.lookup[l - 1].y);this.lookup[d - 1].cy = u[u.length - 1].y - i;
      } else {
        for (l = 0; d > l; l++) o.nx < l * m && (o = u[++n]), this.lookup[l] = o;n < u.length - 1 && (this.lookup[l - 1] = u[u.length - 2]);
      ...
      c = c || {};var d,
        ...
        for (d = [], j = b.rawBezier.length, f = 0; j > f; f += 2) d.push(((q + b.rawBezier[f] * o) * n | 0) / n + "," + ((r + b.rawBezier[f + 1] * -p) * n | 0) / n);d[0] = "M" + d[0], d[1] = "C" + d[1];
      } else for (d = ["M" + q + "," + r], j = Math.max(5, 200 * (c.precision || 1)), g = 1 / j, j += 2, k = 5 / j, l = ((q + g * o) * n | 0) / n, m = ((r + b.getRatio(g) * -p) * n | 0) / n, e = (m - r) / (l - q), f = 2; j > f; f++) h = ((q + f * g * o) * n | 0) / n, i = ((r + b.getRatio(f * g) * -p) * n | 0) / n, (Math.abs((i - m) / (h - l) - e) > k || f === j - 1) && (d.push(l + "," + m), e = (i - m) / (h - l)), l = h, m = i;return s && ("string" == typeof s ? document.querySelector(s) : s).setAttribute("d", d.join(" ")), d.join(" ");
    }, l;
  }, !0);
...
var _gsScope = "undefined" != typeof module && module.exports && "undefined" != typeof global ? global : undefined || window;(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  "use strict";_gsScope._gsDefine("easing.Back", ["easing.Ease"], function (a) {
    var b,
      ...
      b = b || {};for (var c, d, e, f, g, h, i = b.taper || "none", j = [], k = 0, l = 0 | (b.points || 20), m = l, o = b.randomize !== !1, p = b.clamp === !0, q = b.template instanceof a ? b.template : null, r = "number" == typeof b.strength ? .4 * b.strength : .4; --m > -1;) c = o ? Math.random() : 1 / l * m, d = q ? q.getRatio(c) : c, "none" === i ? e = r : "out" === i ? (f = 1 - c, e = f * f * r) : "in" === i ? e = c * c * r : .5 > c ? (f = 2 * c, e = f * f * .5 * r) : (f = 2 * (1 - c), e = f * f * .5 * r), o ? d += Math.random() * e - .5 * e : m % 2 ? d += .5 * e : d -= .5 * e, p && (d > 1 ? d = 1 : 0 > d && (d = 0)), j[k++] = { x: c, y: d };for (j.sort(function (a, b) {
        return a.x - b.x;
      }), h = new n(1, 1, null), m = l; --m > -1;) g = j[m], h = new n(g.x, g.y, h);this._prev = new n(0, 0, 0 !== h.t ? h : h.next);
...
var Controls = (function () {
  function Controls(webgl) {
    ...
    this.props = {
      ...
      colorPallete: [0xff2a5c, 0xffe100],

      toneColorPallete: [0xc300ff, 0x00ddd6],
  ...
  _createClass(Controls, [{
    ...
    key: 'changeDotScale',
    value: function changeDotScale(value) {
      this.objs.uniforms.uDotScale.value = value;
    }
  }, {
    key: 'changeLineScale',
    value: function changeLineScale(value) {
      this.objs.uniforms.uLineScale.value = value;
    }
  }, {
    key: 'switchMotion',
    value: function switchMotion(value) {

      for (var i = 0; i < this.objs.objNum; i++) {
        var tweenMng = this.objs.tweenMngArray[i];
        if (value) {
    ...
    key: 'changeFloorColor',
    value: function changeFloorColor(value) {
      var color = new THREE.Color(value);
      this.webgl.renderer.setClearColor(color, 1.0);
      this.objs.uniforms.uFogColor.value = color;
    }
  }, {
    key: 'changeFloorToneColor',
    value: function changeFloorToneColor(value) {
      var color = new THREE.Color(value);
      this.objs.uniforms.uFloorToneColor.value = color;
    }
  }, {
    key: 'changeColor1',
    value: function changeColor1(value) {
      var color = new THREE.Color(value);
      this.objs.uniforms.uColorArray.value[0] = color;
    }
  }, {
    key: 'changeToneColor1',
    value: function changeToneColor1(value) {
      var color = new THREE.Color(value);
      this.objs.uniforms.uToneColorArray.value[0] = color;
    }
  }, {
    key: 'changeColor2',
    value: function changeColor2(value) {
      var color = new THREE.Color(value);
      this.objs.uniforms.uColorArray.value[1] = color;
    }
  }, {
    key: 'changeToneColor2',
    value: function changeToneColor2(value) {
      var color = new THREE.Color(value);
...
var Objs = (function () {
  function Objs(webgl) {
    ...
    var _colorPallete = this.controls.props.colorPallete;
    var _toneColorPallete = this.controls.props.toneColorPallete;
    ...
    var easePath_rotate = 'M0,0 C0.085,0 0.344,0 0.344,0 0.402,0.538 0.602,1 0.926,1 0.926,1 1,1 1,1';
  ...
  _createClass(Objs, [{
    ...
    value: function createObj() {
      ...
      this.originalG = new THREE.BoxBufferGeometry(this.objSize.x, this.objSize.y, this.objSize.z);
      ...
      for (var i = 0; i < this.objNum; i++) {
        ...
        var defX = i % this.column * (this.objSize.x + this.density);
        var defZ = Math.floor(i / this.column) * (this.objSize.z + this.density);
    ...
    value: function createFloor() {
      var g = new THREE.BoxBufferGeometry(2000, 1, 2000);
...
var ToonManager = (function () {
  function ToonManager(i, objs) {
    _classCallCheck(this, ToonManager);
  ...
  _createClass(ToonManager, [{
    key: "init",
    value: function init() {
      var _this = this;

      var yTween = new TweenMax.fromTo(this.dammy, this.duration, {
        height: 0
      }, {
        height: 150 + 200 * this.speed,
        ease: this.easings.height,
        onUpdate: function onUpdate() {
          _this.aTranslate.needsUpdate = true;
          _this.aTranslate.array[_this.index * 3 + 1] = _this.dammy.height;
        }
      });

      var sTween = new TweenMax.fromTo(this.dammy, this.duration, {
        scaleOffset: 0
      }, {
        scaleOffset: 2.,
        ease: this.easings.scale,
        onUpdate: function onUpdate() {
          _this.aScale.needsUpdate = true;
          _this.aScale.array[_this.index * 3 + 0] = 1 - _this.dammy.scaleOffset;
          _this.aScale.array[_this.index * 3 + 1] = 1 + _this.dammy.scaleOffset;
          _this.aScale.array[_this.index * 3 + 2] = 1 - _this.dammy.scaleOffset;
        }
      });

      var rTween = new TweenMax.fromTo(this.dammy, this.duration, {
        rotateY: 0.25
      }, {
        rotateY: 0.,
        ease: this.easings.rotate,
        onUpdate: function onUpdate() {
          _this.aRotateY.needsUpdate = true;
          _this.aRotateY.array[_this.index] = _this.dammy.rotateY;
        }
      });
      ...
      this.tween.add(yTween.play(), 0).add(sTween.play(), 0).add(rTween.play(), 0);
    }
  }]);
